...
public class klant {
	...
	//id, afb, naam, woonadres		//int, int, string, string
	@POST
	@Path("{id}/{afb}/{naam}/{woonadres}")
	@Produces("application/json")
	public String createKlant(@PathParam("id") int id, @PathParam("afb") int afb,
			@PathParam("naam") String naam, @PathParam("woonadres") String adr,
